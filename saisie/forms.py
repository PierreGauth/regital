...
BudgetSoireeForm = modelform_factory( BudgetSoiree,
  fields=['credit_final_reg', 'debit_initial_reg','montant_cachet','montant_cachet_auteur','nb_total_billets_vendus_reg','nombre_cachets','quart_pauvre_reg','reste_reg','total_depenses_reg','total_recettes_reg','debit_derniere_soiree_reg','total_depenses_corrige_reg'],
	widgets={
		'credit_final_reg': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Crédit final'}),
		'debit_initial_reg': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Débit initial'}),
		'montant_cachet': forms.Select(attrs={'class' : 'form-control input-sm'}),
		'montant_cachet_auteur': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Montant cachet de l\'auteur'}),
		...
		'nombre_cachets': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Nombre de cachets'}),
		'quart_pauvre_reg': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Quart du pauvre'}),
		'reste_reg': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Reste'}),
		'total_depenses_reg': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Total dépenses'}),
		'total_recettes_reg': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Total recettes'}),
		'debit_derniere_soiree_reg': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Débit dernière soirée'}),
		'total_depenses_corrige_reg': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Dépenses corrigées'}),
	},
	labels={
...
DebitForm = modelform_factory(Debit,
  ...
  widgets={
    'montant': forms.NumberInput(attrs={'class' : 'form-control input-sm', 'placeholder' : 'Montant'}),
